      ...
      <div className="mx-auto px-4 md:px-8">
        <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
          <div>
            <div className="h-64 overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-auto">
              <Image
                width="500"
                height="500"
                src="https://images.unsplash.com/photo-1639825988283-39e5408b75e8?auto=format&q=75&fit=crop&w=550&h=550"
          ...
          <div className="md:pt-8">
            <p className="text-center text-2xl font-bold text-yellow-500 md:text-left">
              Service Overview
            </p>
