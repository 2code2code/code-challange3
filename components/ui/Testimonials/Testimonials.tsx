  ...
  return (
    <div className="bg-black py-6 sm:py-8 lg:py-12">
      <div className="mx-auto max-w-screen-xl px-4 md:px-8">
        <h2 className="mb-8 text-center text-2xl font-bold -800 text-yellow-400 md:mb-12 lg:text-3xl ">
        ...
        <div className="grid gap-y-10 sm:grid-cols-2 sm:gap-y-12 lg:grid-cols-3 lg:divide-x">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="text-center text-white">{testimonial.text}</div>
              <div className="flex flex-col items-center gap-2 sm:flex-row md:gap-3">
                ...
                <div>
                  <div className="text-center text-sm font-bold text-yellow-400 sm:text-left md:text-base">
                    {testimonial.name}
                  </div>
