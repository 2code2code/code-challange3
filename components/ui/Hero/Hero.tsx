...
export const Hero = () => {
  return (
    <section className="w-screen relative bg-gradient-to-r from-amber-200 to-yellow-400 flex items-center justify-center overflow-hidden py-16 shadow-lg md:py-20 xl:py-48">
      {/* <Image
        width="1920"
        height="1000"
      ...
      <div className="relative flex flex-col items-center p-4 sm:max-w-xl">
        <h1 className="mb-4 text-center text-yellow-400 font-extrabold tracking-tight text-4xl lg:text-7xl">
          Zeus Chain
        </h1>
